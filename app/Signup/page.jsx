        ...
        <div className="md:flex w-full">
                ...
                data-name="Layer 1" xmlns="http://www.w3.org/2000/svg"
                 width="100%" height="auto" viewBox="0 0 744.84799 747.07702">
                    <path id="fa3b9e12-7275-481e-bee9-64fd9595a50d" data-name="Path 1"
                     ...
                     <path id="b06d66ec-6c84-45dd-8c27-1263a6253192" data-name="Path 6" d="M531.234,337.96451a24.437,24.437,0,0,1,12.23-21.174,24.45,24.45,0,1,0,0,42.345A24.43391,24.43391,0,0,1,531.234,337.96451Z" transform="translate(-227.576 -76.46149)" fill="#ccc"/><path id="e73810fe-4cf4-40cc-8c7c-ca544ce30bd4" data-name="Path 7" d="M561.971,337.96451a24.43594,24.43594,0,0,1,12.23-21.174,24.45,24.45,0,1,0,0,42.345A24.43391,24.43391,0,0,1,561.971,337.96451Z" transform="translate(-227.576 -76.46149)" fill="#ccc"/>
            ...
            <div className="w-full md:w-1/2 py-10 px-5 md:px-10">
                ...
                <div>
                    <div className="flex -mx-3">
                        <div className="w-1/2 px-3 mb-5">
                            ...
                            <div className="flex">
                                ...
                                <input type="text" className="w-full -ml-10 pl-10 pr-3 py-2  border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="John"/>
                            </div>
                        </div>
                        <div className="w-1/2 px-3 mb-5">
                            ...
                            <div className="flex">
                                <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i className="mdi mdi-account-outline text-gray-400 text-lg"></i></div>
                                <input type="text" className="w-full -ml-10 pl-10 pr-3 py-2  border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="Smith"/>
                            </div>
                        </div>
                    </div>
                    <div className="flex -mx-3">
                    ...
                    <div className="flex -mx-3">
                        <div className="w-full px-3 mb-5">
                            <button className="block w-full max-w-xs mx-auto  bg-gradient-to-r from-cyan-300 via-teal-300 to-teal-200 text-white dark:text-white  px-3 py-3 ">REGISTER NOW</button>
                        </div>
                    </div>
                    <Link href="/Login" ><span className='flex items-center justify-center underline hover:text-orange-500'>if you have already register click to go login</span></Link>
                </div>
            </div>
        </div>
    </div>
