...
export default function SignUP() {
  return (
    <div>
        <div class="min-w-screen min-h-screen bg-white dark:bg-[#141432] flex items-center justify-center px-5 py-5">
    <div class="bg-gray-100 text-gray-500 rounded-3xl shadow-xl w-full lg:w-[70%] overflow-hidden">
        <div class="md:flex w-full">
            ...
            <div class="w-full md:w-1/2 py-10 px-5 md:px-10">
                ...
                <div>
                    ...
                    <div class="flex -mx-3">
                        <div class="w-full px-3 mb-5">
                            <button class="block w-full max-w-xs mx-auto  bg-gradient-to-r from-cyan-300 via-teal-300 to-teal-200 text-gray-600 dark:text-white rounded-lg px-3 py-3 font-semibold">REGISTER NOW</button>
                        </div>
                    </div>
                    <Link href="/Login" ><span className='flex items-center justify-center underline hover:text-rose-500'>if you have already register click to go login</span></Link>
                </div>
            </div>
        </div>
    </div>
