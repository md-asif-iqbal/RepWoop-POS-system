...
export default function CreateOwner() {
  ...
  return (
    <div className="bg-white dark:bg-[#141432] font-nunito text-sm">
        <div className=" shadow-sm rounded-lg mt-[25%] lg:mt-[5%] ">
      ...
      <div className="bg-white dark:bg-[#141432] p-10 rounded-lg shadow-sm lg:w-[60%]  -mt-[10%]">
        <h2 className="lg:text-xl mb-6 text-center">Add Owner Information</h2>
