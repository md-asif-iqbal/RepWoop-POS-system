...
export default function CreateOwner() {
  ...
  return (
    <div className="bg-white dark:bg-[#141432] ">
        <div className=" shadow-lg rounded-lg mt-[25%] lg:mt-[5%] ">
      ...
      <div className="bg-white dark:bg-[#141432] p-10 rounded-lg shadow-lg lg:w-[60%]  -mt-[10%]">
        <h2 className="lg:text-2xl mb-6 text-center">Add Owner Information</h2>
