        ...
        <div className="md:flex w-full">
            ...
            <div className="w-full md:w-1/2 py-10 px-5 md:px-10">
                <div className="text-center mb-10">
                    <h1 className="text-lg dark:text-white  text-gray-900">Log In</h1>
                </div>
                <div>
                    ...
                    <div className="flex -mx-3">
                        <div className="w-full px-3 mb-5">
                            ...
                            <div className="flex">
                                ...
                                <input type="email" className="w-full bg-white -ml-10 pl-10 pr-3 py-2  border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="johnsmith@example.com"/>
                            </div>
                        </div>
                    </div>
                    <div className="flex -mx-3">
                        <div className="w-full px-3 mb-12">
                            ...
                            <div className="flex">
                                ...
                                <input type="password" className="w-full bg-white -ml-10 pl-10 pr-3 py-2  border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="************"/>
                            </div>
                        </div>
                    </div>
                    <div className="flex -mx-3">
                        <div className="w-full px-3 mb-2 group">
                            <button className="block w-full max-w-xs mx-auto bg-gradient-to-r from-cyan-300 via-teal-300 to-teal-200 text-white dark:text-white  px-3 py-3 ">LOG IN
                            </button>
