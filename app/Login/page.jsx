        ...
        <div class="md:flex w-full">
            ...
            <div class="w-full md:w-1/2 py-10 px-5 md:px-10">
                <div class="text-center mb-10">
                    <h1 class="text-3xl text-gray-900">Log In</h1>
                </div>
                <div>
                    ...
                    <div class="flex -mx-3">
                        <div class="w-full px-3 mb-2 group">
                            <button class="block w-full max-w-xs mx-auto bg-gradient-to-r from-cyan-300 via-teal-300 to-teal-200 text-gray-600 dark:text-white rounded-lg px-3 py-3 font-semibold">LOG IN
                            </button>
